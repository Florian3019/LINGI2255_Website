	...
	'populateDB': function() {
		...
		function insertCourts(nbr) {
			...
			function getInstructions() {
				if (flipCoin()) {
					return instructions[getRandomInt(0,nInstructions)];
				}
				return undefined;
			}
			function getComment() {
				if (proba(3)) {
					return comments[getRandomInt(0,nComments)];
				}
				return undefined;
			}
			...
			for (var j=0; j<nbr; j++) {
				...
				court = {
					...
					ownerID : owner._id,
					surface : surfaceTypes[getRandomInt(0,4)]
				};
