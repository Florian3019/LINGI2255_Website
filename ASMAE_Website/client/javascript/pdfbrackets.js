  ...
  "click #pdf":function(event,template){
    ...
    html2canvas(html,{
      ...
      onrendered: function(canvas) {
        ...
        // Vertical lign
        context.beginPath();
        context.moveTo(1586, 460);
        context.lineTo(1586, 1360);
        context.lineWidth = 2;

        //Horizontal lign
        context.moveTo(1586,911);
        context.lineTo(1868,911);
        context.lineWidth = 2;
        ...
        //   pdf.text(texte, 315, 20);
        // }
        // var logo = 'data:image/jpeg;base64,';
        // pdf.addImage(logo, 'JPEG',550,15,250,58);
        //
        // if(brack[0].length==16){//Pool size = 32
        //   pdf.addImage(img,'JPEG',130,40,canvas.height<700?canvas.height*ratio:700*ratio,canvas.height<700?canvas.height:700);
        //
        //   pdf.setLineWidth(0.1);
        //   pdf.line(621, 183, 621, 461);
        //   pdf.line(730, 322, 621, 322);
        // }
        // else if (brack[0].length==8) { //Pool size = 16
        //   pdf.addImage(img,'JPEG',130,80,canvas.height<850?canvas.height*ratio:850*ratio,canvas.height<850?canvas.height:850);
        //   pdf.setLineWidth(1);
        //   pdf.line(674, 211, 674, 444);
        //   pdf.line(674, 327, 781, 327);
        // }
        // else if (brack[0].length==4){ // Pool size = 8
        //     pdf.addImage(img,'JPEG',130,100,canvas.height<700?canvas.height*ratio:700*ratio,canvas.height<700?canvas.height:700);
        //   }
        // else if (brack[0].length==2 || brack[0].length==1 ) { //Pool size =4 or 2
        //   pdf.addImage(img,'JPEG',130,220,600,600/ratio);
        // }
        // if(info != undefined){
        //   var filename = "knockoff_"+info.year+"_"+typesTranslate[info.type]+"_"+categoriesTranslate[info.cat]+".pdf";
        // }
        // else{
