  ...
  var knownBrackets = [2,4,8,16,32]; // brackets with "perfect" proportions (full fields, no byes)
    ...
    */
    ...
    $(document).ready(function(){
      $("#pdfBrackets").show("fast",function(){callBack(document, brack);});
    });
}
...
var callBack = function(document, brack){
  var pdf = new jsPDF('portrait','pt','a4');
  var html = document.getElementById('pdfBrackets');
      ...
      html2canvas(html,{
        ...
        onrendered: function(canvas) {
          ...
          pdf.addImage(logo, FORMAT,280,15,250,58);

          if(brack[0].length==16){//Pool size = 32
            pdf.addImage(img,FORMAT,X_OFFSET,Y_OFFSET,MAX_W,MAX_H);
