...
Template.scoreTable.events({
  ...
  */
  'click #getPPDF' : function(event){

    var headerpadding =180;
    /*
    ...
    */
    ...
    courtAddress={"street" : "Gare", "number" : "4", "city" : "Flobecq", "zipCode" : "7880"};
    // Fetch the court
    if(pool.courtID){
      court = Courts.findOne({_id:pool.courtID});
    ...
    */
    var header = function (doc, pageCount, options) {
      //Need to convert the image into dataurl with this website http://dataurl.net/#dataurlmaker
      ...
      doc.addImage(logo, 'JPEG', options.margins.horizontal, 40, 500, 114); // To add an image --> DONE : add ASMAE logo
      doc.setFontSize(20);
      doc.text("Feuille de poule\n", options.margins.horizontal, 180); // DONE : change this to contain the court name. Would be good to add leader/staff info too
      if(leader){
        doc.setFontSize(15);
        ...
        doc.text(leaderText,  options.margins.horizontal, 210);
      }
      if(courtAddress){
          doc.setFontSize(15);
          var addr = "Terrain :\n"+courtAddress.street +" "+ courtAddress.number +"\n"+courtAddress.zipCode+" "+ courtAddress.city;
          doc.text(addr,options.margins.horizontal+400,200);
      }
    ...
    */
    ...
    var footer = function (doc, lastCellPos, pageCount, options) {
      //Need to convert the image into dataurl with this website http://dataurl.net/#dataurlmaker
      //var sponsors = 'data:image/jpeg;base64,'
      //doc.addImage(sponsors, 'JPEG', options.margins.horizontal, doc.internal.pageSize.height - 250, 500, 114); // TODO HERE We can add the sponsors
      doc.text("Cette feuille doit être remise au quartier général à la fin de la poule.",options.margins.horizontal, doc.internal.pageSize.height - 50);
      doc.text("En cas de problème quelconque, n'hésitez pas de nous contacter par téléphone au numéro: +32 (0)2 742 03 01 ",options.margins.horizontal, doc.internal.pageSize.height - 30);
    ...
    */
    ...
    var cell = function (x, y, width, height, key, value, row, settings) {
      ...
      // Draw the box
      pdf.rect(x, y+headerpadding+(settings.lineHeight/2), width, height, fillParam);

      // Get the text
      value = getValue(rows[row][key], settings, width);

      // Draw the text
      pdf.text('' + value["value"], x + value["offset"], y+headerpadding+settings.lineHeight);
    };
    ...
    var headerCell = function (x, y, width, height, key, value, settings){
      ...
      // Draw the box
      pdf.rect(x, y+headerpadding+(settings.lineHeight/2), width, height, 'F');
  ...
  'click #getPDF':function(event){
    ...
    */
    ...
    var footer = function (doc, lastCellPos, pageCount, options) {
      ...
      //var sponsors = 'data:image/jpeg;base64,'
      //doc.addImage(sponsors, 'JPEG', options.margins.horizontal, doc.internal.pageSize.height - 250, 500, 114); // TODO HERE We can add the sponsors
      doc.text("Cette feuille doit être remise au quartier général à la fin de la poule.",options.margins.horizontal, doc.internal.pageSize.height - 30);
      doc.text("En cas de problème quelconque, n'hésitez pas de nous contacter par téléphone au numéro: +32 (0)2 742 03 01 ",options.margins.horizontal, doc.internal.pageSize.height - 10);
      // var footerText = "Page " + pageCount + " sur " + totalPagesExp; // Display the page number
      // doc.text(footerText, options.margins.horizontal, doc.internal.pageSize.height - 10); // Position of the page number display
    };
